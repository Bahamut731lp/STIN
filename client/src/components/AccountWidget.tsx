...
export default function AccountWidget(props: AccountWidgetProps) {
    ...
    return (
        <div className="inline-grid gap-8 p-8 bg-neutral-800">
            ...
            <DepositModal active={props.identifier.prefix} isOpen={deposit} setIsOpen={setDeposit} accounts={_accounts}/>
            <PaymentModal active={props.identifier.prefix} isOpen={payment} setIsOpen={setPayment} accounts={_accounts}/>
            <AccountHistoryModal active={props.identifier.prefix} isOpen={transactionHistory} setIsOpen={setTransactionHistory} accounts={_accounts}/>
